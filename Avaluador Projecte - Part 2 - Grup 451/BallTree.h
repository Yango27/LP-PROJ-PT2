...
private:
	...
	void construirArbreRec(std::vector<Coordinate>& coordenades, BallTree* root);
	double distanciaMax(Coordinate& c1, Coordinate& cRes, const std::vector<Coordinate>& coordenades);
};
